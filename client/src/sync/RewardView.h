...
// display table (see ParseEquipmentTable) generated from the versioned
...
// Parses tab-separated "id, name, slot, description" rows generated by CMake
// from data/equipment/catalog.json. '#' starts a comment; blank lines are ignored.
